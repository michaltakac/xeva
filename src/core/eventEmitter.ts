/**
 * Event emitter for XReva store
 * Based on Leva's event emitter implementation
 */
...
/**
 * Creates a lightweight event emitter for handling store events
 * Used for onEditStart/onEditEnd callbacks
 */
...
export type { EventEmitter, Listener };